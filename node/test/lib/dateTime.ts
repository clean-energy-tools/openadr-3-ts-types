...
import {
    DateTime, zodSchemaDateTime, Duration, zodSchemaDuration,
...
describe('DATE TIME DURATION', function() {
    ...
    describe('ZOD', function() {
        ...
        it('should parse dateTime', function() {
            ...
            const dateTime: DateTime = zodSchemaDateTime.parse(data.dateTimes[0]) as DateTime;
        ...
        it('should parse duration 0', function() {
            ...
            const dateTime: Duration = zodSchemaDuration.parse(data.durations[0]) as Duration;
            // console.log(dateTime);
        ...
        it('should parse duration 1', function() {
            ...
            const dateTime: Duration = zodSchemaDuration.parse(data.durations[1]) as Duration;
            // console.log(dateTime);
        ...
        it('should parse duration 2', function() {
            ...
            const dateTime: Duration = zodSchemaDuration.parse(data.durations[2]) as Duration;
            // console.log(dateTime);
            assert.deepEqual(dateTime, "-P1Y2M3DT1H20M10S" as any);
        });
        ...
        it('should parse duration 3', function() {
            ...
            const dateTime: Duration = zodSchemaDuration.parse(data.durations[3]) as Duration;
            // console.log(dateTime);
            assert.deepEqual(dateTime, "-P2M3DT1H20M10S" as any);
        });
    });
