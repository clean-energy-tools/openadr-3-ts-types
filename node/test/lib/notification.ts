...
describe('NOTIFICATION', function() {
    ...
    describe('ZOD', function() {
        ...
        it('should parse notification GET PROGRAM', function() {
            const notification: Notification = zodSchemaNotification.parse(data.notifications[0]) as Notification;
        ...
        it('should parse notification POST REPORT', function() {
            const notification: Notification = zodSchemaNotification.parse(data.notifications[1]) as Notification;
            // console.log(notification);
            assert.deepEqual(notification, {
                objectType: 'REPORT',
                operation: 'POST',
        ...
        it('should parse notification PUT EVENT', function() {
            const notification: Notification = zodSchemaNotification.parse(data.notifications[2]) as Notification;
            // console.log(notification);
            assert.deepEqual(notification, {
                objectType: 'EVENT',
                operation: 'PUT',
        ...
        it('should parse notification DELETE SUBSCRIPTION', function() {
            const notification: Notification = zodSchemaNotification.parse(data.notifications[3]) as Notification;
            // console.log(notification);
            assert.deepEqual(notification, {
        ...
        it('should parse notification GET VEN', function() {
            const notification: Notification = zodSchemaNotification.parse(data.notifications[4]) as Notification;
            // console.log(notification);
            assert.deepEqual(notification, {
                objectType: 'VEN',
                operation: 'GET',
        ...
        it('should parse notification POST RESOURCE', function() {
            const notification: Notification = zodSchemaNotification.parse(data.notifications[5]) as Notification;
            // console.log(notification);
            assert.deepEqual(notification, {
                objectType: 'RESOURCE',
                operation: 'POST',
        ...
        it('should parse notification POST RESOURCE w/ missing field', function() {
            const notification: Notification = zodSchemaNotification.parse(data.notifications[6]) as Notification;
            // console.log(notification);
            assert.deepEqual(notification, {
                objectType: 'RESOURCE',
                operation: 'POST',
        ...
        it('should fail to parse notification w/ incorrect operation code', function() {
            let didFail = false;
            try {
                const notification: Notification = zodSchemaNotification.parse(data.BADnotifications[0]) as Notification;
            } catch (err: any) {
                didFail = true;
        ...
        it('should fail to parse notification w/ missing operation code', function() {
            let didFail = false;
            try {
                const notification: Notification = zodSchemaNotification.parse(data.BADnotifications[1]) as Notification;
            } catch (err: any) {
                didFail = true;
                // console.log(err.issues);
                assert.deepEqual(err.issues, [
        ...
        it('should fail to parse notification w/ incorrect operation type', function() {
            let didFail = false;
            try {
                const notification: Notification = zodSchemaNotification.parse(data.BADnotifications[2]) as Notification;
            } catch (err: any) {
                didFail = true;
                // console.log(err.issues);
