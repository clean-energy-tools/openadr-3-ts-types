...
// GenerateValidationSimple generates simplified validation functions
func GenerateValidationSimple(opts BuildOptions) error {
	PrintBanner("Generating simplified Go validation functions")
	...
	validationCode := `package ` + opts.PackageName + `
...
`
	...
	if _, err := file.WriteString(validationCode); err != nil {
