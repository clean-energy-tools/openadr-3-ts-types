 ...
 */
export type Program = ObjectMetadata & ProgramRequest;
/**
 * Client provided description of program
 */
 ...
 * report object.
 */
export type Report = ObjectMetadata & ReportRequest & {
    clientID: ClientID;
};
/**
 * report object.
 ...
 */
export type Event = ObjectMetadata & EventRequest;
/**
 * Event object to communicate a Demand Response request to VEN.
 * If intervalPeriod is present, sets default start time and duration of intervals.
 */
 ...
 * updated, or deleted.
 */
export type Subscription = ObjectMetadata & SubscriptionRequest & {
    clientID: ClientID;
};
/**
 * An object created by a client to receive notification of operations on objects.
...
export type VenRequest = VenVenRequest | BlVenRequest;
/**
 * Business Logic provided representation of ven.
 */
export type BlVenRequest = {
    /**
     * Used as discriminator.
     */
...
export type ResourceRequest = BlResourceRequest | VenResourceRequest;
/**
 * Business Logic provided representation of ven resource.
 */
export type BlResourceRequest = {
    /**
     * Used as discriminator.
     */
 ...
 * Business Logic provided representation of ven resource.
 */
export type VenResourceRequest = {
    /**
     * Used as discriminator.
     */
...
export type MqttNotifierBindingObject = {
     ...
     */
    authentication: MqttNotifierAuthenticationAnonymous | MqttNotifierAuthenticationOauth2BearerToken | MqttNotifierAuthenticationCertificate;
};
/**
...
//# sourceMappingURL=openadr3Schemas.d.ts.map