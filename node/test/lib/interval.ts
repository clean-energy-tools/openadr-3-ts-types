...
import {
    Interval, zodSchemaInterval, joiInterval
...
describe('INTERVAL', function() {
    ...
    describe('ZOD', function() {
        ...
        it('should parse interval', function() {
            ...
            const interval: Interval = zodSchemaInterval.parse(data.intervals[0]) as Interval;
        ...
        it('should parse interval w/ randomized start', function() {
            const interval: Interval = zodSchemaInterval.parse(data.intervals[1]) as Interval;
            // console.log(interval);
            assert.deepEqual(interval, {
                id: 1,
                intervalPeriod: {
        ...
        it('should parse interval w/ negative durations', function() {
            const interval: Interval = zodSchemaInterval.parse(data.intervals[2]) as Interval;
            // console.log(interval);
            assert.deepEqual(interval, {
                id: 2,
                intervalPeriod: {
        ...
        it('should parse interval w/ extra data, no passthrough, no data', function() {
            const interval: Interval = zodSchemaInterval.parse(data.intervals[3]) as Interval;
            // console.log(interval);
            assert.deepEqual(interval, {
                id: 3,
                intervalPeriod: {
        ...
        it('should parse interval w/ extra data, passthrough, see data', function() {
            ...
            const interval: Interval = zodSchemaInterval.passthrough().parse(data.intervals[3]) as Interval;
            // console.log(interval);
            assert.deepEqual(interval, {
                id: 3,
        ...
        it('should fail to parse interval w/ extra data, strict', function() {
            let didFail = false;
            try {
                const interval: Interval = zodSchemaInterval.strict().parse(data.intervals[3]) as Interval;
            } catch (err: any) {
                didFail = true;
                // console.log(err);
        ...
        it('should fail to parse interval w/ bad data', function() {
            ...
            try {
                ...
                const interval: Interval = zodSchemaInterval.parse(data.BADintervals[0]) as Interval;
            } catch (err: any) {
                didFail = true;
                // console.log(err);
                assert.deepEqual(err.issues, [
