...
import {
    Event, zodSchemaEventRequest, joiEventRequest,
    EventRequest
...
describe('EVENT', function() {
    ...
    describe('ZOD', function() {
        ...
        it('should parse event', function() {
            ...
            const event: EventRequest = zodSchemaEventRequest.parse(data.events[0]) as EventRequest;
            // console.log(event);
        ...
        it('should parse event with extra fields and passthrough', function() {
            const event: EventRequest = zodSchemaEventRequest.passthrough().parse(data.events[0]) as EventRequest;
            // console.log(event);
            assert.deepEqual(event, {
                programID: '0',
                eventName: 'First event',
        ...
        it('should fail to parse event with extra fields and strict', function() {
            let didFail = false;
            try {
                const event: EventRequest = zodSchemaEventRequest.strict().parse(data.events[0]) as EventRequest;
            } catch (err: any) {
                didFail = true;
                // console.log(err);
        ...
        it('should parse event with default values', function() {
            const event: EventRequest = zodSchemaEventRequest.parse(data.eventsDefaults[0]) as EventRequest;
            // console.log(event);
            assert.deepEqual(event, {
                programID: '0',
        ...
        it('should fail to parse event wtih bad values', function() {
            let didFail = false;
            try {
                const event: EventRequest = zodSchemaEventRequest.parse(data.eventsBadValues[0]) as EventRequest;
            } catch (err: any) {
                didFail = true;
                // console.log(err);
                assert.deepEqual(err.issues, [
